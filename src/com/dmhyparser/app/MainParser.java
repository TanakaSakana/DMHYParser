package com.dmhyparser.app;

import com.dmhyparser.context.BANGUMI;
import com.dmhyparser.info.dmhy.BangumiInfo;
import com.dmhyparser.info.dmhy.Year;
import com.dmhyparser.parser.helper.JSONBangumiParser;
import com.dmhyparser.parser.helper.JSONIndexParser;
import com.dmhyparser.parser.wiki.CombinedParser;
import com.dmhyparser.thread.DescriptionParserThread;
import com.dmhyparser.thread.SeasonParserThread;
...
public class MainParser {
    ...
    *   2. Reads bangumi for each year index*/
    public static boolean update() throws Exception {
        ...
        List<SeasonParserThread> threads = new ArrayList<SeasonParserThread>();
